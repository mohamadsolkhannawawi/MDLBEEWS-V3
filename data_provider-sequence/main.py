...
logger = get_logger("dataprovidersequence")
...
if __name__ == '__main__':
    logger.info("Starting Data Provider (data_provider-sequence)...")
    ...
    main(station_path='./data_provider-sequence/data/stations.json', num_processes=30, num_station_configs=6000)
